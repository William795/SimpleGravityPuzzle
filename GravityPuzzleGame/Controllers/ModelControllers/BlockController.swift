...
class BlockController {
    ...
    let grayBlocktemplate = Block(colorReference: 5, propertiesReference: 5, startingPoint: CGPoint(x: 110, y: 100), goalPoint: CGPoint(x: 0, y: 0), blockSize: CGSize(width: 0, height: 0), isInPlace: false)
